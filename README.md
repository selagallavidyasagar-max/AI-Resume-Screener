...
ATS Optimization: Provides a score based on how well the resume is optimized for Applicant Tracking Systems.

Job Matching: Compares the resume content against a provided job description to calculate a similarity/match percentage.

Career Insights: Suggests missing keywords and areas of improvement to increase the chances of getting hired.
